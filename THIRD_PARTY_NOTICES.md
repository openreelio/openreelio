...
OpenReelio bundles the third-party components listed below. Each is
redistributed under its own license; the full license texts follow the
component list.


## Bundled Fonts

These font families are compiled into the OpenReelio application and the
`openreelio-cli` binary (`src-tauri/src/core/text/bundled_fonts.rs`) so that
burned-in captions render identically on every machine. The font files and
their upstream license files live under `src-tauri/fonts/`.
...
- License: OFL-1.1 (full text below)
- Upstream license file: `src-tauri/fonts/anton/OFL.txt`
...
- License: OFL-1.1 (full text below)
- Upstream license file: `src-tauri/fonts/archivo-black/OFL.txt`
...
- License: OFL-1.1 (full text below)
- Upstream license file: `src-tauri/fonts/bebas-neue/OFL.txt`
...
- License: OFL-1.1 (full text below)
- Upstream license file: `src-tauri/fonts/poppins/OFL.txt`
