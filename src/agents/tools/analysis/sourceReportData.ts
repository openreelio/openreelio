...
export function buildSourceAnalysisReportPayload({
  ...
  const report = {
    ...
    audio: {
      ...
      truePeakDbtp: roundTo(audioProfile?.truePeakDbtp ?? undefined),
      integratedLufs: roundTo(audioProfile?.integratedLufs ?? undefined),
      loudnessRangeLu: roundTo(audioProfile?.loudnessRangeLu ?? undefined),
