const SEMANTIC_TOOL_ALIASES: Record<string, string> = {
  ...
  add_callout: 'add_text_clip',
  add_credit: 'add_text_clip',
  add_credits: 'add_text_clip',
  add_logo_bug: 'add_text_clip',
  add_social_handle: 'add_text_clip',
  ...
  create_callout: 'add_text_clip',
  create_credit: 'add_text_clip',
  create_credits: 'add_text_clip',
  create_lower_third: 'add_text_clip',
  create_lowerthird: 'add_text_clip',
  create_logo_bug: 'add_text_clip',
  create_social_handle: 'add_text_clip',
  ...
  delete_transcript_selection: 'delete_transcript_range',
  ...
  get_transcript_selection: 'get_transcript_words',
  ...
  place_callout: 'add_text_clip',
  place_credit: 'add_text_clip',
  place_credits: 'add_text_clip',
  place_logo_bug: 'add_text_clip',
  place_social_handle: 'add_text_clip',
  ...
  remove_transcript_range: 'delete_transcript_range',
  remove_transcript_selection: 'delete_transcript_range',
